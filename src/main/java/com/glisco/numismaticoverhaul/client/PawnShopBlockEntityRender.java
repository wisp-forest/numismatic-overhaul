...
public class PawnShopBlockEntityRender implements BlockEntityRenderer<PawnShopBlockEntity> {

    public PawnShopBlockEntityRender(BlockEntityRendererFactory.Context context) {
        super();
    }

    @Override
    public void render(PawnShopBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
